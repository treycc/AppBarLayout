...
public class BadgeItem {
    ...
    public BadgeItem setHint(boolean isHint) {
        this.mIsHint = isHint;
        return this;
    }
    ...
    protected BadgeItem setHintView(ImageView hintView) {
        this.mImageViewRef = new WeakReference<ImageView>(hintView);
        return this;
    }
    ...
    private void refreshDrawable() {
        ...
        if(isHintReferenceValid()){
            ImageView imageView = mImageViewRef.get();
            imageView.setBackgroundDrawable(BottomNavigationHelper.getBadgeDrawable(this, imageView.getContext()));
        }
    }
    ...
    private boolean isHintReferenceValid() {
