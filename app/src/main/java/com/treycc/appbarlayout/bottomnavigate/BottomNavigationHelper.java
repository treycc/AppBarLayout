package com.treycc.appbarlayout.bottomnavigate;
...
import com.treycc.appbarlayout.bottomnavigate.utils.Utils;
...
class BottomNavigationHelper {
    ...
    private static void setBadgeForTab(BadgeItem badgeItem, BottomNavigationTab bottomNavigationTab) {
        if (badgeItem != null) {
            ...
            if(badgeItem.isHint()){
                GradientDrawable shape = getHintDrawable(badgeItem, context);
                bottomNavigationTab.hintView.setBackgroundDrawable(shape);
                bottomNavigationTab.setBadgeItem(badgeItem);
                badgeItem.setHintView(bottomNavigationTab.hintView);
                bottomNavigationTab.hintView.setVisibility(View.VISIBLE);

                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) bottomNavigationTab.hintView.getLayoutParams();
    ...
    static GradientDrawable getHintDrawable(BadgeItem badgeItem, Context context) {
        GradientDrawable shape = new GradientDrawable();
        shape.setShape(GradientDrawable.RECTANGLE);
        shape.setCornerRadius(Utils.dp2px(context, 12));
        shape.setColor(badgeItem.getBackgroundColor(context));
        shape.setSize(Utils.dp2px(context, 12), Utils.dp2px(context, 12));
    ...
    static GradientDrawable getBadgeDrawable(BadgeItem badgeItem, Context context) {
        GradientDrawable shape = new GradientDrawable();
        shape.setShape(GradientDrawable.RECTANGLE);
        shape.setCornerRadius(Utils.dp2px(context, 18));
        shape.setColor(badgeItem.getBackgroundColor(context));
        shape.setSize(Utils.dp2px(context, 18), Utils.dp2px(context, 18));
        shape.setStroke(badgeItem.getBorderWidth(), badgeItem.getBorderColor(context));
        return shape;
    }
